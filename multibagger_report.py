#!/usr/bin/env python3
"""
Multibagger Report — NSE Strong Momentum Trend Scanner
Strategy: Monthly RSI>70 + ATH Breakout + Ultra-Slow MACD(34,1000,20) + MTF Confirmation
Fibonacci Extension Targets + Volume Breakouts + Backtested Signals
"""
...
def _trade_table(trades):
    ...
    return f'''<div style="margin-top:16px">
      <h4 style="color:#8b949e;font-size:12px;margin-bottom:8px">📋 Backtest Trades (last 10)</h4>
