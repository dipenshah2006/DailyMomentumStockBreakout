...
<body>
    ...
    <!-- DataTables container (hidden until initialised) -->
    <div id="dtContainer">
    ...
    <script>
        ...
        try {{
            $(document).ready(function() {{
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapse${{i}}" class="accordion-collapse collapse" data-bs-parent="#indexAccordion">
                            <div class="accordion-body">
                                <div id="chart_${{i}}" style="width:100%; height:600px;"></div>
                                <div class="table-responsive mt-3">
                                    <table id="table_${{i}}" class="table table-striped table-bordered" style="width:100%">
                                        <thead><tr>
                ...
                // Lazy initialise tables and charts when an accordion item is opened
                $('#indexAccordion').on('shown.bs.collapse', '.collapse', function() {{
                    const collapseId = $(this).attr('id');  // e.g. "collapse0"
                    const i = collapseId.replace('collapse', '');
                    const iname = Object.keys(detailData)[i];
                    const tableId = '#table_' + i;
                    const chartDiv = 'chart_' + i;

                    // Initialise DataTable if not already done
                    ...
                    // Initialise Plotly chart if not already done
